...
% Objective 1: Baltimore volumetric reliability
objs(1) = sum(w(:,2)+w(:,4)) / sum(local_demand(:,2)+local_demand(:,4));

% Objective 2: Peach Bottom nuclear plant reliability
objs(2) = 1 - sum(w(:,3) < local_demand(:,3)-1E-6) / T;
