...
% by Charles Rougé, Spring 2022
% 
% This routine is a basic step-by-step version of the water balance with a
% modified standard operating policy (SOP), assuming no downstream demand
% 
...
function flows = water_balance_keep(reservoir, flows)
...
for t =1:T
    ...
    for i = 1:length(reservoir.demand_intake_level)
        if head(t) > reservoir.demand_intake_level(i) 
